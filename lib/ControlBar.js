...
function ControlBar() {
    ...
    return (React.createElement(View, { style: styles.container },
        React.createElement(IconButton, { iconID: "arrow-back", text: "Back", onPress: onPressBack }),
        React.createElement(IconButton, { iconID: "done", text: "Done", onPress: onFinishEditing, disabled: shouldDisableDoneButton })));
}
export { ControlBar };
