...
function EditingWindow(props) {
    ...
    const [imageScaleFactor, setImageScaleFactor] = recoil_1.useRecoilState(Store_1.imageScaleFactorState);
    ...
    return (<react_native_1.View style={styles.container}>
      ...
      {isCropping && state.imageLayout.height != null ? (<ImageCropOverlay_1.ImageCropOverlay fixedAspectRatio={props.fixedCropAspectRatio} lockAspectRatio={props.lockAspectRatio} minimumCropDimensions={props.minimumCropDimensions}/>) : null}
    </react_native_1.View>);
}
