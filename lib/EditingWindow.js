...
function EditingWindow() {
    ...
    return (React.createElement(View, { style: styles.container },
        usesGL ? (React.createElement(View, { style: styles.glContainer },
            React.createElement(GLView, { style: [
                    {
                        height: 1,
                        width: 1,
                        backgroundColor: "#ccc",
                    ...
                    getGLLayout(),
                ], onContextCreate: onGLContextCreate }))) : (React.createElement(Image, { style: styles.image, source: { uri: imageData.uri }, onLayout: ({ nativeEvent }) => getImageFrame(nativeEvent.layout) })),
        isCropping && imageLayout != null ? React.createElement(ImageCropOverlay, null) : null));
}
