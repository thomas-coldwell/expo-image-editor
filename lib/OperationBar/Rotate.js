...
function Rotate() {
    ...
    return (<react_native_1.View style={styles.container}>
      <react_native_1.View style={[styles.row, { paddingHorizontal: 200 }]}>
        <IconButton_1.IconButton iconID="rotate-left" text="Rotate -90" onPress={() => setRotation(rotation + (react_native_1.Platform.OS === "web" ? 90 : -90))}/>
        <IconButton_1.IconButton iconID="rotate-right" text="Rotate +90" onPress={() => setRotation(rotation - (react_native_1.Platform.OS === "web" ? 90 : -90))}/>
      </react_native_1.View>
