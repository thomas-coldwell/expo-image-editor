...
function Blur() {
    ...
    return (<react_native_1.View style={styles.container}>
      <react_native_1.View style={[styles.row, { justifyContent: "center" }]}>
        <react_native_slider_1.Slider value={blur} onValueChange={(value) => setBlur(value[0])} step={1} minimumValue={1} maximumValue={50} minimumTrackTintColor="#00A3FF" maximumTrackTintColor="#ccc" thumbTintColor="#c4c4c4" containerStyle={styles.slider} trackStyle={styles.sliderTrack}/>
      </react_native_1.View>
