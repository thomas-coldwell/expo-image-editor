...
function Blur() {
                ...
                if (asset.width && asset.height) {
                    ...
                    if (vert && frag) {
                        ...
                        if (program) {
                            ...
                            const pixelFrequency = Math.round(imageData.width / imageBounds.width / 2);
    ...
    }} step={1} minimumValue={1} maximumValue={30} minimumTrackTintColor="#00A3FF" maximumTrackTintColor="#ccc" thumbTintColor="#c4c4c4" containerStyle={styles.slider} trackStyle={styles.sliderTrack}/>
      </react_native_1.View>
      <react_native_1.View style={styles.row}>
        <IconButton_1.IconButton iconID="close" text="Cancel" onPress={() => onClose()}/>
        <react_native_1.Text style={styles.prompt}>Blur Radius: {sliderValue}</react_native_1.Text>
