...
function Blur() {
    ...
    React.useEffect(() => {
        if (glContext !== null) {
            const setupGL = () => __awaiter(this, void 0, void 0, function* () {
                ...
                const gl = glContext;
                let asset = expo_asset_1.Asset.fromURI(imageData.uri);
    ...
    return (<react_native_1.View style={styles.container}>
      <react_native_1.View style={[styles.row, { justifyContent: "center" }]}>
        <react_native_slider_1.Slider value={blur} onValueChange={(value) => setBlur(value[0])} step={1} minimumValue={1} maximumValue={50} minimumTrackTintColor="#00A3FF" maximumTrackTintColor="#ccc" thumbTintColor="#c4c4c4" containerStyle={styles.slider} trackStyle={styles.sliderTrack} thumbStyle={styles.sliderThumb}/>
      </react_native_1.View>
