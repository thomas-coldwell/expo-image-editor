...
const ImageCropOverlay = () => {
    ...
    return (React.createElement(GestureHandlerRootView, { style: styles.container },
        React.createElement(PanGestureHandler, { onGestureEvent: onOverlayMove, onHandlerStateChange: (e) => onHandlerStateChange(e) },
            ...
            horizontalSections.map((hsection) => {
                return (React.createElement(View, { style: styles.sectionRow, key: hsection }, verticalSections.map((vsection) => {
                    const key = hsection + vsection;
                    return (React.createElement(View, { style: [styles.defaultSection], key: key }, 
                    // Add the corner markers to the topleft,
                    // topright, bottomleft and bottomright corners to indicate resizing
                    key == "topleft" ||
                        key == "topright" ||
                        key == "bottomleft" ||
                        key == "bottomright" ? (React.createElement(View, { style: [
                            styles.cornerMarker,
                            hsection == "top"
