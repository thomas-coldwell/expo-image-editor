...
function ImageCropOverlay(props) {
    ...
    const [scale, setScale] = React.useState(new react_native_1.Animated.Value(1.0));
    ...
    const { imageBounds, fixedAspectRatio, accumulatedPan, cropSize, minimumCropDimensions } = props;
