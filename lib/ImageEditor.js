...
function ImageEditor(props) {
            ...
            if (react_native_1.Platform.OS == "web") {
                yield ImageManipulator.manipulateAsync(uri, [
                    ...
                    if (props.mode == 'crop-only') {
                        ...
                        setEditorState(Object.assign(Object.assign({}, editorState), { processing: false, imageData: { uri, width, height }, editingMode: "operation-select" }));
                    }
                })
                    .catch((error) => {
    ...
    return (<PlatformModal visible={props.visible} transparent animationType="slide">
      ...
      {editorState.ready ? (<react_native_1.View style={styles.container}>
          <ControlBar_1.ControlBar onPressBack={() => editorState.editingMode == "operation-select"
        ? props.onCloseEditor()
        : setEditorState(Object.assign(Object.assign({}, editorState), { editingMode: "operation-select" }))} onPerformCrop={() => onPerformCrop()} editingMode={editorState.editingMode} onChangeMode={(editingMode) => setEditorState(Object.assign(Object.assign({}, editorState), { editingMode }))} onRotate={(angle) => onRotate(angle)} onFinishEditing={() => onFinishEditing()} mode={props.mode}/>
    ...
    }} cropSize={editorState.cropSize} onUpdateCropSize={(size) => setEditorState(Object.assign(Object.assign({}, editorState), { cropSize: size }))} onUpdatePanAndSize={({ accumulatedPan, size }) => setEditorState(Object.assign(Object.assign({}, editorState), { cropSize: size, accumulatedPan }))} isCropping={editorState.editingMode == "crop" ? true : false}/>
