...
const modal_enhanced_react_native_web_1 = __importDefault(require("modal-enhanced-react-native-web"));
const PlatformModal = react_native_1.Platform.OS == 'web' ? modal_enhanced_react_native_web_1.default : react_native_1.Modal;
function ImageEditor(props) {
    ...
    return (props.visible ?
        <PlatformModal visible={props.visible} transparent>
