...
function ImageEditor(props) {
    ...
    const onPerformCrop = () => __awaiter(this, void 0, void 0, function* () {
        ...
        yield ImageManipulator.manipulateAsync(editorState.imageData.uri, [
            { crop: croppingBounds }
        ])
    ...
    return (<PlatformModal visible={props.visible} transparent animationType='slide'>
      <react_native_1.StatusBar hidden/>
        ...
        <react_native_1.View style={styles.container}>
              <ControlBar_1.ControlBar onPressBack={() => props.onCloseEditor()} onPerformCrop={() => onPerformCrop()} mode={editorState.mode} onChangeMode={mode => setEditorState(Object.assign(Object.assign({}, editorState), { mode }))} onRotate={angle => onRotate(angle)}/>
