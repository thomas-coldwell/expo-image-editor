    ...
    return (<PlatformModal visible={props.visible} transparent animationType='slide'>
      <react_native_1.StatusBar hidden/>
        ...
        <react_native_1.View style={styles.container}>
              ...
              <EditingWindow_1.EditingWindow imageData={props.imageData} fixedCropAspectRatio={1 / props.fixedCropAspectRatio} lockAspectRatio={props.lockAspectRatio} imageBounds={editorState.imageBounds} minimumCropDimensions={props.minimumCropDimensions} onUpdateImageBounds={bounds => setEditorState(Object.assign(Object.assign({}, editorState), bounds))} accumulatedPan={editorState.accumulatedPan} onUpdateAccumulatedPan={accumulatedPan => {
            setEditorState(Object.assign(Object.assign({}, editorState), { accumulatedPan: accumulatedPan }));
        }} cropSize={editorState.cropSize} onUpdateCropSize={size => setEditorState(Object.assign(Object.assign({}, editorState), { cropSize: size }))} onUpdatePanAndSize={({ accumulatedPan, size }) => setEditorState(Object.assign(Object.assign({}, editorState), { cropSize: size, accumulatedPan }))}/>
            </react_native_1.View>
        : null}
